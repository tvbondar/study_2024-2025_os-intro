...
1. Выполним все примеры, приведённые в первой части описания лабораторной работы. (рис. @fig:001). (рис. @fig:002). (рис. @fig:003). (рис. @fig:004).
...
3. Изменим права доступа ряду файлов (рис. @fig:007). (рис. @fig:008). 

![ч. 1](image/7.png){#fig:007 width=70%}  

![ч. 2](image/8.png){#fig:008 width=70%} 

4.   Просмотрим содержимое файла /etc/password.(рис. @fig:009). (рис. @fig:010). 

![/etc](image/9.png){#fig:009 width=70%} 

5.  Скопируем файл ~/feathers в файл ~/file.old. Переместим файл ~/file.old в каталог ~/play. Скопируем каталог ~/play в каталог ~/fun. Переместим каталог ~/fun в каталог ~/play и назовем его games. Лишим владельца файла ~/feathers права на чтение. Что произойдёт, если вы попытаетесь просмотреть файл ~/feathers командойcat? Отказано в доступе. Что произойдёт, если вы попытаетесь скопировать файл ~/feathers? ОТказано в доствупе. Дадим владельцу файла ~/feathers право на чтение. Лишим владельца каталога ~/play права на выполнение. Перейдем в каталог ~/play. Дадим владельцу каталога ~/play право на выполнение.(рис. @fig:010). 

![Операции с файлами](image/10.png){#fig:010 width=70%} 

6. Прочитаем man по командам mount, fsck, mkfs, kill (рис. @fig:011). (рис. @fig:012). (рис. @fig:013). (рис. @fig:014). 
